...
// Seed data for initial Solako setup
...
export const seedProducts = [
  {
    ...
    description: 'This is a sample product for your Solako store.',
...
export const seedGlobals = {
  ...
  footer: {
    ...
    copyright: '© 2024 Solako. All rights reserved.',
  },
  settings: {
    siteName: 'Solako',
